# Data Coverage Report — 2026-08-01
...
**Snapshot used:** `data/cache/snapshots/20260801T074655.json` (fetched 2026-08-01T07:46:40.812518+00:00)
...
| COIN-XBT.ST | CoinShares XBT Provider Bitcoin Tracker One (certificate) | avanza-isk | **ERROR** | yahoo chart unreachable: HTTP Error 404: Not Found (fallback path also failed) | 3 |
...
- COIN-XBT.ST (CoinShares XBT Provider Bitcoin Tracker One (certificate)): 3 sweeps — yahoo chart unreachable: HTTP Error 404: Not Found (fallback path also failed)
...
**Last funnel run** (data/cache/rankings/20260729T150852-ranking.json, generated 2026-07-29T15:08:52.153526+00:00, categories: sp500,europe_large_cap,thesis_candidates): 449 full-factor ranked, 61 momentum-only (no fundamentals), 0 set aside (no data at all).
