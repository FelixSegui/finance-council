...
> **⚠ SUPERSEDED — this memo was generated by the automated Monday cloud
> routine against `portfolio.json` as of commit `34bc915` (2026-07-06),
> because a parallel local session's work (2026-07-07 through 2026-07-13)
> had not yet been pushed to `origin/main` when the routine ran at 06:00 UTC
> on 2026-07-13. Its portfolio-status claims below — including "Handelsbanken
> wrapper still unresolved" and the 18.7% avanza-isk concentration flag — are
> FALSE as of this session: the HB wrapper was confirmed and the funds sold
> on 2026-07-12, and avanza-isk has since been fully itemized (no single
> holding breaches 15%). Treat `data/portfolio.json` and
> `reports/SESSION_LOG.md` as authoritative over this memo's specific
> numbers. Its process observations (reconciliation method, calibration
> notes) remain valid and are preserved below unedited.*
